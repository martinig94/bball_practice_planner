...
155 drills in English, written for this project (no external source). One row per
drill; list fields are `;`-separated. Offense has its own category with half-court
